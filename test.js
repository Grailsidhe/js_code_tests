...
const canWork = instructors.filter(name => {
  if(name.specialities.includes("Javascript") 
      && !name.specialities.includes("Python") 
      && name.availability === "all" 
      || name.availability === "weekend") {
    console.log(`Hi ${name.name}, we inform you that this weekend you will be doing the support class.`)
  } else if(name.specialities.includes("Javascript") 
      && name.specialities.includes("Python") 
      && name.availability === "all" 
      || name.availability === "weekend") {
    console.log(`Hi ${name.name}, we inform you that this weekend you will be doing the support class and you need to prepare a Python workshop.`)
  } else {}
})
